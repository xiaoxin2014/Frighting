...
public class IntroductionActivity extends AppCompatActivity {
    ...
    private void getData() {
        ...
        params.put("mesId", idOth);
        OkHttpHelper.getInstance().post(Contants.API.MESSAGEDETAIL, params, new SimpleCallback<Msg>(this) {
            @Override
