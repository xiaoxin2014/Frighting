package my.tlol.com.frighting.view;
...
public class SelectPicPopupWindow extends PopupWindow {
	...
	public SelectPicPopupWindow(Context context, OnClickListener itemsOnClick, String photoUrl) {
		super(context);
		...
		Log.d("SelectPicPopupWindow","photoUrl="+photoUrl);
