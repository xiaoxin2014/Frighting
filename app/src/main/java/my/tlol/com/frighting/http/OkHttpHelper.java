                    ...
                    if(response.isSuccessful()) {
                        ...
                        if (callback.mType == String.class){
                            ...
                            try {
                                ...
                                if (!PreferencesUtils.getBoolean(MyApplication.getInstance().getContext(), "isLogin", false)){
                                    /*Headers headers = response.headers();
                                    List<String> cookies = headers.values("Set-Cookie");
                                    String session = cookies.get(0);
                                    PreferencesUtils.putString(MyApplication.getInstance().getContext(),"session",session);*/
                                }
    ...
    private  Request buildPostRequest(String url,Map<String,Object> params){
        ...
        private  Request buildRequest(String url,HttpMethodType methodType,Map<String,Object> params){
                ...
                Request.Builder builder = new Request.Builder()
                        .url(url);
            String session =PreferencesUtils.getString(MyApplication.getInstance().context, "session","");
            if (!session.isEmpty()){
